  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/beranda" class="nav-link">Pergi Ke Beranda</a>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto">
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/logout" class="nav-link" data-toggle="modal" data-target="#logoutModal">Keluar</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ketapel</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
